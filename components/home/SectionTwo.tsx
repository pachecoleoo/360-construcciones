...
export default function SectionTwo() {
  ...
  return (
    <section className="mt-12 overflow-hidden bg-[#081835] px-6 pt-12 pb-8 text-center sm:px-8 md:px-10 md:py-3 md:text-left lg:px-16">
      <div
        ref={ref}
        className={`
          mx-auto max-w-7xl
      ...
      >
        ...
        >
          <Image
            src="/images/gaticaPngRecorte.png"
            alt="Infraestructura y movimiento de suelo"
            width={280}
            height={460}
            className="h-auto w-[270px] opacity-90 sm:w-[230px] md:w-[280px]"
            priority
          />

          {/* BOTÓN SOLO MOBILE */}
          <div className="mt-0 mb-12 md:hidden">
