...
export default function ContactFormSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-[6%] top-0 hidden w-px bg-[#E7EEF2] lg:block" />
      <div className="absolute bottom-0 right-[6%] top-0 hidden w-px bg-[#E7EEF2] lg:block" />
        ...
        <div className="grid gap-14 lg:grid-cols-12">
          <div className="lg:col-span-5">
            ...
            <div className="mt-10 grid gap-4">
              <div className="group block border border-[#D7E2E9] bg-white p-6 transition-all duration-800 hover:-translate-y-[3px] hover:border-[#4f5255] hover:bg-[#062a47] hover:shadow-[0_22px_55px_rgba(37,211,102,0.25)]">
              ...
              <div className="group block border border-[#D7E2E9] bg-white p-6 transition-all duration-800 hover:-translate-y-[3px] hover:border-[#4f5255] hover:bg-[#062a47] hover:shadow-[0_22px_55px_rgba(6,42,71,0.25)]">
              ...
              <a
                ...
                className="group block border border-[#D7E2E9] bg-white p-6 transition-all duration-800 hover:-translate-y-[3px] hover:border-[#25D366] hover:bg-[#25D366] hover:shadow-[0_22px_55px_rgba(37,211,102,0.25)]"
              >
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#062a47]/55 transition-colors duration-300 group-hover:text-white">
          ...
          <div className="lg:col-span-7">
            <div className="border border-[#D7E2E9] bg-white">
              ...
              <div className="p-8">
                <div id="email" className="mb-8 border-b border-[#E5EDF2] pb-5">
                  ...
                  <div className="flex justify-end pt-4">
                    ...
                    >
                      <span
                        aria-hidden
                        className="
                          absolute inset-0 translate-x-[-100%] bg-[#C9D8E2]
