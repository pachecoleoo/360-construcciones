          ...
          <div className="mx-auto max-w-7xl px-6 grid gap-10 lg:grid-cols-2 items-center">
            ...
            <div>
              ...
              <p className="mt-4 text-slate-600 leading-relaxed">
                Trabajamos con un enfoque integral: definimos objetivos,
                relevamos requerimientos, planificamos plazos y presupuesto, y
                ejecutamos con control técnico. Nuestro diferencial es la
                coordinación entre disciplinas y la comunicación clara con el
                cliente.
              </p>
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 p-5">
                  ...
                  <p className="mt-2 text-slate-800">
                    Entregar obras confiables, eficientes y estéticamente
                    sólidas, cuidando calidad y tiempos.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-slate-200 p-5">
                  ...
                  <p className="mt-2 text-slate-800">
                    Ser referentes por la excelencia técnica, la transparencia y
                    la mejora continua en cada proyecto.
                  </p>
                </div>
              </div>
          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="max-w-2xl">
              ...
              <p className="mt-3 text-slate-600">
                Priorizamos procesos claros para que el proyecto avance sin
                sorpresas.
              </p>
            </div>
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              {[
                {
                  title: "Transparencia",
                  desc: "Presupuestos claros, seguimiento y comunicación constante.",
                },
                {
                  title: "Calidad",
                  desc: "Estándares técnicos y control de ejecución en cada etapa.",
                },
                {
                  title: "Planificación",
                  desc: "Cronogramas realistas, hitos y orden de trabajo.",
                },
                {
                  title: "Compromiso",
                  desc: "Cumplimos lo acordado y cuidamos el detalle final.",
                },
              ].map((v) => (
                <div
                  key={v.title}
              ...
              {[
                {
                  step: "01",
                  title: "Relevamiento",
                  desc: "Objetivos, alcance, sitio y requisitos.",
                },
                {
                  step: "02",
                  title: "Propuesta",
                  desc: "Presupuesto, plazos y plan de trabajo.",
                },
                {
                  step: "03",
                  title: "Ejecución",
                  desc: "Coordinación, control técnico y avances.",
                },
                {
                  step: "04",
                  title: "Entrega",
                  desc: "Cierre, documentación y post-obra.",
                },
              ].map((p) => (
                <div
                  key={p.step}
